...
//Criar construtor sem estar selecionado o ArrayList
	...
	/*
	 * Aqui não posso permitir, é a lista que inicia com o construtor que deve ser
	 * usada, usando os métodos os métodos de add e remover não posso permitir que
	 * essa lista seja trocada. public void setContracts(List<HourContract>
...
//Esse método vai adicionar um item a minha lista que foi criada em cima como atributo
	...
	public double income(int year, int month) {
		...
		// Agora preciso percorrer a lista desse worker e testar se ano e mes batem com
		// o solicitado
